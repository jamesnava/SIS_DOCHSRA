...
class PDF():
	def __init__(self,nro_expediente,Razon,Asunto,tipo):
		...
		self.Hoja.setFont('Banana',8)
		self.Hoja.drawString(int(self.width*0.73),self.height-150,"Tipo:")
		self.Hoja.setFont('Helvetica',10)
		self.Hoja.drawString(int(self.width*0.8),self.height-150,tipo)
